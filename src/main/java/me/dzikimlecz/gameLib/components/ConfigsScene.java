package me.dzikimlecz.gameLib.components;
...
import me.dzikimlecz.gameLib.enums.Difficulty;
import me.dzikimlecz.gameLib.enums.Theme;
import me.dzikimlecz.gameLib.model.GameProperties;
...
public class ConfigsScene extends Scene {
	...
	private final GameProperties gameConfigs;
	private final Stage window;
	
	public ConfigsScene(Stage window, String title, GameProperties gameConfigs) {
		super(new BorderTitlePane(title));
